...
if [ "${useNetwork}" = "Yes" ]; then
  ...
  #
  sudo mv /etc/wpa_supplicant/wpa_supplicant.conf /etc/wpa_supplicant/wpa_supplicant.conf.${date}
  sudo cp /etc/wpa_supplicant/wpa_supplicant.detnswcorp /etc/wpa_supplicant/wpa_supplicant.conf
